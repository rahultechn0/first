    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-xl-6 col-xxl-12">
          ...
          @forelse($latestPackage as $item)  <td>@php echo  $trans->referralUser->registerId; @endphp</td>
                    ...
                    <div class="referral-left">
                      ...
                      @if(($userData->packageAmt)>0)
                        <p>
                          ...
                          <p class="m-0" style="word-break:break-all;" id="refLink_1">http://127.0.0.1:8000/register/{{ $userData['registerId']}}</p>
                  ...
                  <div class="table-responsive">
                    <table class="table text-center bg-info-hover tr-rounded order-tbl">
                      <thead class="position-sticky">
                        <tr>
                          <th class="text-left text-white"><b>S.no</b></th>
