    ...
    <div class="row">
                  <div class="col-xl-12 col-xxl-12">
                    <div class="form-head mb-sm-2 mb-2 d-flex align-items-center flex-wrap">
                      <h3 class="font-w600 mb-0 me-auto mb-2">Level Report</h3>
                    </div>
                    <div class="card">
                            ...
                            <table id="example" class="w-100 display dataTable" role="grid" aria-describedby="example_info">
                              <thead>
                                <tr role="row">
                                  ...
                                  <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending">Type</th>
